...
QUEUE = [
    ...
    {
        "book": "MoonBound",
        "slug": "moonbound-2087-lunar-forge",
        "title": "Lunar Captivity Forged the Exodus Discipline",
        "description": "A MoonBound field note on the 2087 lunar prison years, hidden Freemen networks, and how the Exodus project turned captivity into unbreakable preparation for the ark.",
        "image": "https://picsum.photos/id/1015/1200/630",
        "body": """
        <p><strong>MoonBound</strong> takes the Exodus story into the lunar years of 2087. The Freemen have reached the Moon but the escape from Earth has not ended the pressure. It has only changed its shape. The League still hunts. The survivors still live under surveillance and scarcity. The book shows how the secret project of building the ark became a test of endurance that lasted years rather than weeks.</p>
        <p>The lunar setting forces every decision into sharper focus. Air, water, power, and information are all rationed. The hidden bases cannot afford mistakes because there is no backup planet nearby. The characters who were mechanics and students on Earth become engineers and commanders who must keep complex systems running with limited parts and no margin for error. The book treats the Moon as a proving ground rather than a refuge.</p>
        <p>One of the strongest threads is the growth of the resistance network. What began as a small recruitment effort on Earth has become a distributed web of cells across multiple lunar sites. Communication is slow and dangerous. Trust is earned through repeated deliveries of supplies and information under the noses of League patrols. The book shows how ordinary people become reliable links in that chain. A technician who falsifies maintenance logs. A medic who diverts medical stock. A pilot who flies extra routes without logging the hours. Each small act compounds into the larger capability that will one day move hundreds of people to the waiting carrier.</p>
        <p>The story refuses to romanticize the lunar period. The bases are cramped, cold, and always one failure away from disaster. People die from equipment malfunctions and from the psychological weight of living in permanent hiding. The book tracks how the constant threat changes the people who survive. Some grow harder and more decisive. Others burn out and have to be replaced. The leadership that emerges is not the leadership that was planned. It is the leadership that proved it could keep the project alive when every week brought new reasons to abandon it.</p>
        <p><strong>MoonBound</strong> connects directly to the earlier books by showing what the Freemen learned from the curfew streets and the compliance officers. The same attention to detail that kept David Corb alive on Earth now keeps the lunar workshops running. The same distrust of centralized authority that drove the initial recruitment now shapes how the cells operate with minimal hierarchy. The book makes clear that the Exodus project succeeded because the people involved had already practiced living outside the system before they ever left the planet.</p>
        <p>The military and technical texture remains strong. The book spends time on the logistics of moving people and materials between sites without detection. It shows the engineering challenges of building a carrier that can support a long voyage while hidden in lunar shadow. The training of pilots and engineers happens in secret simulators and under real pressure. Every test flight risks exposure. Every new recruit risks betrayal. The story earns its tension through these concrete constraints rather than through abstract declarations of rebellion.</p>
        <p>The human cost is never glossed over. Families are separated. Relationships form and break under the strain of secrecy. Children born on the Moon know only the underground corridors and the constant need for silence. The book shows how the next generation inherits both the mission and the scars of the people who started it. The question of what kind of society the Freemen are building for themselves runs through every chapter. They are not only escaping the League. They are trying to become something the League could never produce.</p>
        <p>That continuity makes <strong>MoonBound</strong> essential for readers who want the full weight of the Exodus saga. The flight from Earth was only the first step. The years on the Moon turned the escape into a sustained campaign that required discipline, patience, and the willingness to accept that the plan might fail at any moment. The book ends with the carrier nearly complete and the decision to launch still hanging in the balance. The tension comes from knowing how much has already been sacrificed and how much more may still be lost.</p>
        <p>If you want the middle chapter of the Exodus story, the one that turns the initial break into a viable future, read <strong>MoonBound</strong>. It shows the lunar prison years as the forge that turned desperate refugees into the disciplined core that would carry humanity outward. The official 2087 entry belongs on every shelf that already holds Chaos Rising. Start here when you want to understand why the ark was not only built but why it was ready when the moment finally came.</p>
        """,
    },
]
