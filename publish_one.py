...
QUEUE = [
    ...
    },
    {
        ...
        <p>The appeal here is the ragged edge of civilization. This is not a polished future where humanity solved itself by reaching another system. It is a future where people brought their appetites, debts, and grudges with them. The machinery is newer. The moral problems are ancient.</p>
        <p>That makes the book useful for readers who like science fiction with dirt under its nails. The Altair-era story is not about a shining fleet moving in perfect order. It is about groups forced into proximity, people making ugly bargains, and survival plans that only work if nobody asks too many questions about the cost.</p>
        <p>What keeps <strong>BioRift</strong> connected to the earlier Exodus books is the series obsession with systems under stress. Air, water, medical care, transport, chain of command, loyalty, and information all become contested resources. When those systems break, character is revealed fast. The generous become tired. The disciplined become dangerous. The frightened become unpredictable.</p>
        <p>The title points toward rupture, and the story earns that feeling. A rift is not only a place. It is a condition. The people in this era live inside gaps: between official maps and real terrain, between command claims and field truth, between old ideals and the brutal math of what can actually be saved.</p>
        <p>That is the kind of science fiction Exodus does best. It does not ask whether humanity can build impressive technology. It asks whether humans can remain human while depending on machines, sealed habitats, failing plans, and leaders who may be guessing under pressure.</p>
        <p>For readers coming from <strong>Chaos Rising</strong>, the pleasure is seeing how far the consequences travel. The Freemen's flight was never a clean ending. It was a beginning. By 2898, the descendants of that break are still dealing with the same central question: what must be preserved, and what must be abandoned, when survival stops being theoretical?</p>
        <p><strong>BioRift</strong> belongs to readers who like their space opera tense, practical, and morally crowded. Start it when you want Exodus at its roughest edge, where nobody gets to pretend the future is safe just because Earth is far behind.</p>
        """,
    },
    {
        "book": "SandRats",
        ...
        <p>That is why the title matters. Sand rats are survivors, not conquerors. They live close to the ground. They know routes, shelters, caches, signals, and silences. They survive because they respect the environment more than their own pride. In Exodus terms, that makes them kin to every mechanic, medic, pilot, and fugitive who kept going when the official plan broke.</p>
        <p>The far-future frame also gives the series room to ask a sharper question. If humanity escaped tyranny, collapse, and the long dark between worlds, why is survival still so hard? The answer is simple and unpleasant. People carry their old patterns with them. A new planet or frontier does not erase fear, ambition, greed, loyalty, or love. It only gives those forces new terrain.</p>
        <p><strong>SandRats</strong> is built for readers who like frontier science fiction where every tool matters. Vehicles, shelters, weapons, water stores, maps, and local knowledge are not props. They are the difference between returning and becoming one more warning story. The action works because the background pressure never lets up.</p>
        <p>There is also a strong family resemblance to the earlier Exodus books. The same series that made curfew streets feel dangerous can make open desert feel watched. The same series that treated education and repair work as resistance can treat local survival knowledge as power. Nobody lives long here by accident.</p>
        <p>That is the sales promise. <strong>SandRats</strong> takes the Exodus saga into a harsher frontier without losing the core concern: ordinary people under extraordinary pressure, making decisions with incomplete information and no guarantee that virtue will be rewarded.</p>
        <p>If you want the Altair-era side of Exodus, read <strong>SandRats</strong>. It is the reminder that the promised future still has teeth, and that survival belongs to the people disciplined enough to notice where the sand has shifted.</p>
        """,
    },
]
